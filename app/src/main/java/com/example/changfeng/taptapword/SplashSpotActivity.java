...
//						MyLog.i("YoumiAdDemo", "开屏展示成功");
//					}
//
//					@Override
//					public void onShowFailed() {
//						MyLog.i("YoumiAdDemo", "开屏展示失败。");
//					}
//
//					@Override
//					public void onSpotClosed() {
//						MyLog.i("YoumiAdDemo", "开屏关闭。");
//					}
//				});
...
//		MainActivity.class);
    ...
    protected void onStart() {
        ...
        int launchTimes = pref.getInt("launch_times", 0);

        if (launchTimes++ < 10) {
            SharedPreferences.Editor editor = getSharedPreferences("config", MODE_PRIVATE).edit();
            editor.putInt("launch_times", launchTimes).commit();
